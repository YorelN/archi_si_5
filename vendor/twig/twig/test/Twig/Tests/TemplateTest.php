...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage Block "unknown" on template "home.twig" does not exist in "home.twig".
     */
    public function testRenderBlockWithUndefinedBlock()
    {
        $twig = new Twig_Environment($this->getMockBuilder('Twig_LoaderInterface')->getMock());
        $template = new Twig_TemplateTest($twig, 'home.twig');
        try {
    ...
    /**
     * @expectedException Twig_Error_Runtime
     * @expectedExceptionMessage Block "foo" should not call parent() in "home.twig" as the block does not exist in the parent template "parent.twig"
     */
    public function testDisplayBlockWithUndefinedParentBlock()
    {
        $twig = new Twig_Environment($this->getMockBuilder('Twig_LoaderInterface')->getMock());
        $template = new Twig_TemplateTest($twig, 'parent.twig');
        $template->displayBlock('foo', array(), array('foo' => array(new Twig_TemplateTest($twig, 'home.twig'), 'block_foo')), false);
    }
    ...
    public function getGetAttributeTests()
    {
        ...
        $tests = array_merge($tests, array(
            array(false, null, 42, 'a', array(), $anyType, 'Impossible to access an attribute ("a") on a integer variable ("42") in "home.twig".'),
            array(false, null, 'string', 'a', array(), $anyType, 'Impossible to access an attribute ("a") on a string variable ("string") in "home.twig".'),
            array(false, null, array(), 'a', array(), $anyType, 'Key "a" does not exist as the array is empty in "home.twig".'),
        ));
...
class Twig_TemplateTest extends Twig_Template
{
    ...
    public function __construct(Twig_Environment $env, $name = 'home.twig')
    {
